/**
 * OpenAI Realtime WebRTC client — speech-to-speech test harness only.
 */
import { API_BASE, REALTIME_CALLS_URL, REALTIME_MODEL } from "./config";
...
export class RealtimeSession {
  ...
  async connect(options: RealtimeConnectOptions): Promise<void> {
    const tokenRes = await fetch(`${API_BASE}/token`, { method: "POST" });
